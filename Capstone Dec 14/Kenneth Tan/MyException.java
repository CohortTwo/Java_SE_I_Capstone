...
public class MyException {
    ...
    public static void menu() {
        System.out.println("--------------Book Rcords-----------");
    ...
    public static void add() {
        try{                  // try and catch method introduced; input of "add book" should be in int form
        // throw new MyException("Self defined Exception");
            
        int id;
            
        if(id == Integer.parseInt(0))
            throw new idZeroException("zero is an invalid value");
        
            System.out.println(idZeroException);
      ...
      }catch(idZeroException ez){                     //exception handling in play
              System.out.println("error" + ez.getMessage());
              
  //  }catch(Exception e2){ 
  //           System.out.println("INTEGERS ONLY PLEASE - GENERIC (e2)");  // generic exception handling
}
    }        
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static void delete() {
        if (arr.size() != 0) {
            ...
            if (j == 0) {
                System.out.println("System has no relevant book information");
            }
        } else {
            System.out.println("System has no relevant book information");
        }
