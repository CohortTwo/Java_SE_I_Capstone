...
//close the connection object  
    ...
    public static void updateEmpRec() {
        try {
            connection.beginRequest();
            String updateRecord = "UPDATE employees SET job_id = ?, salary = ?, manager_id = ?, department_id = ? WHERE employee_id = ?";
            ...
            System.out.println("Please enter new value to update job position: ");
            pstmt.setString(1, in.next());
            System.out.println("Please enter new value to update salary: ");
            pstmt.setInt(2, in.nextInt());
            System.out.println("Please enter new value to update manager: ");
            pstmt.setInt(3, in.nextInt());
            System.out.println("Please enter new value to update department: ");
            pstmt.setInt(4, in.nextInt());
