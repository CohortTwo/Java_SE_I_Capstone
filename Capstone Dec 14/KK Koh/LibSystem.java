...
public class LibSystem {
    ...
    static void showAllBooks() {
        if (books.isEmpty()) System.out.println("RESULT : =========== No Book in the Library System! ==============\n\n");
        else {
            System.out.println("RESULT :");
            books.forEach(book -> {
                System.out.print("Book{id=" + book.getId() + ", Title=" + book.getTitle()
                        + ", Author=" + book.getAuthor());
                if (book.getCusId() == 0) System.out.println(", Available for loan}");
                else System.out.println(", Customer id=" + book.getCusId() + "}");
            });
            System.out.println("\n\n");
        }
    }
        ...
        if (books.isEmpty()) System.out.println("RESULT : ============== No Book in the Library System! ============\n\n");
            ...
            for (int i = 0; i < books.size(); i++) {
                if (books.get(i).getId() == id) {
                    ...
                    if (books.get(1).getCusId() == 0) System.out.println(", Available for loan}\n\n");
                    else System.out.println(", Customer id=" + books.get(i).getCusId() + "}\n\n");
                    break;
                }
            }
            if (!bIdFound) System.out.println("RESULT : ============== No Such Book id ============\n\n");
        }
    }
    ...
    static void addBook() {
        ...
        else System.out.println("RESULT : =============== Invalid Book id ==============\n\n");
    }
                ...
                for (int i = 0; i < books.size(); i++) {
                    if (books.get(i).getId() == id) {
                        ...
                        if (cusId > 0) {
                            ...
                            if (cusId == 0) System.out.println(", Available for loan}\n\n");
                            
                            else System.out.println(", Customer id=" + cusId + "}\n\n");
                            
                        } 
                        else System.out.println("RESULT : ========== Invalid Customer id ==============\n\n");
        ...
        if (books.isEmpty()) System.out.println("RESULT : ============== No Book in the Library System! ============\n\n");
            ...
            for (int i = 0; i < books.size(); i++) {
                if (books.get(i).getId() == id) {
                    ...
                    else System.out.println("RESULT : ========= Book on loan - Not able to delete ==========\n\n");
        ...
        if (books.isEmpty()) System.out.println("RESULT : ============== No Book in the Library System! ============\n\n");
            ...
            for (int i = 0; i < books.size(); i++) {
                if (books.get(i).getId() == bid) {
                    bIdFound = true;
                    if (books.get(i).getCusId() != 0) System.out.println("RESULT : ========= Book on loan ===========\n\n");
                    else {
    ...
    static void returnBook() {
        if (books.isEmpty()) {
            ...
            for (int i = 0; i < books.size(); i++) {
                if (books.get(i).getId() == bid) {
                    bIdFound = true;
                    if (books.get(i).getCusId() == 0) System.out.println("RESULT : ========= Book is already in the Library! ===========");
                    else {
